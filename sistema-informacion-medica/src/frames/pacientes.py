from PySide6.QtWidgets import QWidget, QLabel, QVBoxLayout, QFormLayout, QHBoxLayout, QLineEdit, QComboBox, QDateEdit, QTimeEdit, QPushButton, QMessageBox, QSpacerItem, QSizePolicy, QCheckBox
from PySide6.QtGui import QIntValidator, QRegularExpressionValidator
from PySide6.QtCore import QDate, QTime, QRegularExpression
...
class Pacientes(QWidget):
    ...
    def create_paciente_frame(self):
        ...
        self.cedula_entry_paciente.setFixedWidth(10)
        ...
        self.nombres_entry_paciente.setFixedWidth(50)
        ...
        self.apellidos_entry_paciente.setFixedWidth(50)
        ...
        self.telefono_entry_paciente.setFixedWidth(15)
        ...
        self.genero_combobox_paciente.currentIndexChanged.connect(self.toggle_embarazo_fields)
        ...
        self.lugar_nacimiento_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression("[A-Za-z ]{1,50}")))
        self.lugar_nacimiento_entry_paciente.setMaxLength(50)
        self.lugar_nacimiento_entry_paciente.setFixedWidth(50)
        ...
        self.direccion_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.direccion_entry_paciente.setMaxLength(200)
        self.direccion_entry_paciente.setFixedWidth(200)
        self.direccion_entry_paciente.setStyleSheet("background-color: white;")
        row_layout3.addWidget(QLabel("Dirección:"))
        row_layout3.addSpacerItem(QSpacerItem(1, 0, QSizePolicy.Minimum, QSizePolicy.Minimum))
        row_layout3.addWidget(self.direccion_entry_paciente)
        
        self.nacionalidad_entry_paciente = QLineEdit()
        self.nacionalidad_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.nacionalidad_entry_paciente.setMaxLength(200)
        self.nacionalidad_entry_paciente.setFixedWidth(200)
        ...
        self.profesion_ocupacion_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.profesion_ocupacion_entry_paciente.setMaxLength(200)
        self.profesion_ocupacion_entry_paciente.setFixedWidth(200)
        ...
        self.religion_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.religion_entry_paciente.setMaxLength(200)
        self.religion_entry_paciente.setFixedWidth(200)
        ...
        self.contacto_emergencia_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,100}")))
        self.contacto_emergencia_entry_paciente.setMaxLength(200)
        self.contacto_emergencia_entry_paciente.setFixedWidth(200)
        ...
        self.parentesco_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.parentesco_entry_paciente.setMaxLength(200)
        self.parentesco_entry_paciente.setFixedWidth(200)
        ...
        self.motivo_consulta_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.motivo_consulta_entry_paciente.setMaxLength(200)
        self.motivo_consulta_entry_paciente.setFixedWidth(200)
        ...
        self.enfermedad_actual_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.enfermedad_actual_entry_paciente.setMaxLength(200)
        self.enfermedad_actual_entry_paciente.setFixedWidth(200)
        ...
        self.diagnostico_admision_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.diagnostico_admision_entry_paciente.setMaxLength(200)
        self.diagnostico_admision_entry_paciente.setFixedWidth(200)
        ...
        self.intervencion_tratamiento_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.intervencion_tratamiento_entry_paciente.setMaxLength(200)
        self.intervencion_tratamiento_entry_paciente.setFixedWidth(200)
        ...
        self.diagnostico_final_entry_paciente.setValidator(QRegularExpressionValidator(QRegularExpression(".{1,500}")))
        self.diagnostico_final_entry_paciente.setMaxLength(200)
        self.diagnostico_final_entry_paciente.setFixedWidth(200)
        ...
        self.save_button_paciente.setFixedSize(150, 30)  # Establecer tamaño fijo
        ...
        self.clear_button_paciente.setFixedSize(150, 30)  # Establecer tamaño fijo
